...
@section('title', 'Magserv | Nova Manutenção Preventiva')

@section('content')

    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Agendar Manutenção Preventiva</h1>
            <p class="text-gray-600 mt-1">Preencha os dados abaixo para programar uma nova visita preventiva.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="date" id="data_inicio_atendimento" name="data_inicio_atendimento" 
                           value="{{ old('data_inicio_atendimento') }}" 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                    ...
                    <input type="date" id="data_fim_atendimento" name="data_fim_atendimento" 
                           value="{{ old('data_fim_atendimento') }}" 
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
